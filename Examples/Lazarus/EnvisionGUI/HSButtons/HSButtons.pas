...
type
   ...
   THSButtonLayout = TButtonLayout;//(blGlyphLeft, blGlyphRight, blGlyphTop, blGlyphBottom);
   THSButtonStyle = (bsNormal, bsEncarta, bsModern, bsOld, bsShape, bsQuicken, bsRounded, bsGlass);
...
begin
   ...
   case ColorStyle of
      ...
      lcsBlue:        begin Color := clBlue;  LightColor := clwhite;      ShadowColor := clNavy;     ColorWhenDown := clNone;     HotTrackColor := clWhite;FontColor:=clwhite;     Modern := true; end;
      ...
      lcsGlassBlue:        begin Color := clBlue;  {LightColor := clAqua;      ShadowColor := clBlue;}     ColorWhenDown := clNone;     HotTrackColor := clNone; FontColor:=clWhite end;
