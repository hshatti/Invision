...
{   case FStyle of
   ...
   aLayout := THSButtonLayout.blGlyphLeft;
   case FLayout of
      THSButtonLayout.blGlyphTop:    aLayout := THSButtonLayout.blGlyphTop;
      THSButtonLayout.blGlyphRight:  aLayout := THSButtonLayout.blGlyphRight;
      THSButtonLayout.blGlyphBottom: aLayout := THSButtonLayout.blGlyphBottom;
   end;
